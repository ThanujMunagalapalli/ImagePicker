package com.github.thanujmunagalapalli.imagepicker.provider
...
import com.github.thanujmunagalapalli.imagepicker.ImagePicker
import com.github.thanujmunagalapalli.imagepicker.ImagePickerActivity
import com.github.thanujmunagalapalli.imagepicker.util.ExifDataCopier
import com.github.thanujmunagalapalli.imagepicker.util.FileUtil
import com.github.thanujmunagalapalli.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.thanujmunagalapalli.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
